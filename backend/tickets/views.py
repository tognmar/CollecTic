...
def upload_ticket(request):
    ...
    try:
        ...
        system_instructions = (
            ...
            "   - 'title_artist': a single string of performing bands or artists."
            "If more than one artist is listed, join the names with ", " (comma-space)."
            "If the event is a (festival, sport event attraction or show) set this to the (festival, sport event, attraction or show) name instead. "
